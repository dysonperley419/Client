...
const modules = import.meta.glob('../assets/client-preview*.{png,jpg,jpeg,webp}', { eager: true });
const PREVIEW_IMAGES = Object.values(modules).map((mod: any) => mod.default);
...
const Landing = (): JSX.Element => {
    ...
    const nextImg = () => setCurrentImg((prev) => (prev + 1) % PREVIEW_IMAGES.length);
    const prevImg = () => setCurrentImg((prev) => (prev - 1 + PREVIEW_IMAGES.length) % PREVIEW_IMAGES.length);

    return (
        <div className="landing-wrapper">
            {isZoomed && (
                <div className="image-modal-overlay" onClick={() => setIsZoomed(false)}>
            ...
            <nav className="landing-navbar">
                ...
                <div className="navbar-links">
                    ...
                    <a title="GitHub" href="https://github.com/FlickerTeam/Client" target="_blank" rel="noreferrer" className="nav-icon-link">
            ...
            <main className="landing-body">
                <section className="hero-section">
                    <div className="hero-visual" ref={containerRef}
                        ...
                        <div className="image-3d-container" onClick={() => setIsZoomed(true)}>
                            <img src={PREVIEW_IMAGES[currentImg]} alt="Flicker Client" className="client-render" style={{
               ...
               <section className="features-section">
                    ...
                    <h2 className='section-title' style={{
                        marginTop: '30px'
                    }}>.. And more! You can find all details on our github</h2>
                </section>
            ...
            <footer className='landing-footer'>
                <div className="footer-main">
                    <p>&copy; 2026 <Link to="https://github.com/FlickerTeam" target="_blank" rel="noreferrer">Flicker Team</Link>. All rights reserved.</p>
                </div>
                <div className="footer-attribution">
                    <span>Icons by: </span>
                    <Link to="https://www.flaticon.com/free-icons/arrows" title="arrows icons" target="__blank">Pixel perfect</Link>
                    <span className="dot">•</span>
                    <Link to="https://www.flaticon.com/free-icons/github" title="github icons" target="__blank">riajulislam</Link>
                    <span className="dot">•</span>
                    <Link to="https://www.flaticon.com/" title="Flaticon" target="__blank">Flaticon</Link>
                </div>
            </footer>
        </div>
    );
