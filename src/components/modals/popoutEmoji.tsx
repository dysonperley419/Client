                ...
                <div className='popout-header'>
                    <div className='avatar-wrapper-centered overlap'>
                        <img
                            ...
                            style={{ objectFit: 'contain', padding: '8px', background: 'var(--bg-panel)', pointerEvents: 'none' }}
                        />
                    </div>
                    ...
                    <div className='about-me-container emoji-origin-card'>
                        <div className='guild-info-row'>
                            <div className='guild-details'>
                                <div className='guild-icon-name' onClick={(e) => {
                                    e.stopPropagation();
                                    closePopup();
                                ...
                                {isPrivate && (
                                    <span className='private-guild-tag'>This guild is private</span>
                                )}
                            </div>
                        </div>
                    </div>
